...
with tf.compat.v1.variable_scope('layer_1'):
    weights = tf.compat.v1.get_variable(name="weights1", shape=[number_of_inputs, layer_1_nodes], initializer=tf.keras.initializers.glorot_normal())
...
with tf.compat.v1.variable_scope('layer_2'):
    weights = tf.compat.v1.get_variable(name="weights2", shape=[layer_1_nodes, layer_2_nodes], initializer=tf.keras.initializers.glorot_normal())
...
with tf.compat.v1.variable_scope('layer_3'):
    weights = tf.compat.v1.get_variable(name="weights3", shape=[layer_2_nodes, layer_3_nodes], initializer=tf.keras.initializers.glorot_normal())
...
with tf.compat.v1.variable_scope('output'):
    weights = tf.compat.v1.get_variable(name="weights4", shape=[layer_3_nodes, number_of_outputs], initializer=tf.keras.initializers.glorot_normal())
